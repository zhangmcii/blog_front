...
<template>
  <div class="notifications-container">
    <div class="header">
      ...
      <el-button :disabled="notifications.length <= 0" @click="handleMakeAll">
        <template #icon><van-icon name="brush-o" /></template>
      </el-button>
    </div>
          ...
          <li class="notification-item" @click="handleClick(item)">
            ...
            <div class="message-content">
              <p class="notification-title">
                {{
                  `${item.triggerNickName ? item.triggerNickName : item.triggerUsername} ${
                    item.type
                  } 了你`
                }}
              </p>
    ...
    <div class="footer">
      <el-button :disabled="notifications.length <= 0" class="clear-btn" @click="handleClear">
        清空
      </el-button>
      <!-- <el-button class="view-all-btn" @click="handleViewAll"> 查看所有消息 </el-button> -->
    </div>
  </div>
</template>
<style scoped>
